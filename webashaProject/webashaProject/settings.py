"""
Django settings for webashaProject project.
...
SECRET_KEY = os.getenv('DJANGO_SECRET_KEY', 'django-insecure-&z$abr4%2!s#%)^fh80ofc@$7wb%yag*^+z9w98iy1k2a3^s14')

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = os.getenv('DJANGO_DEBUG', 'True') == 'True'

ALLOWED_HOSTS = os.getenv('DJANGO_ALLOWED_HOSTS', '*').split(',') # Update with your domain in production
...
ROOT_URLCONF = 'webashaProject.urls'
...
WSGI_APPLICATION = 'webashaProject.wsgi.application'
