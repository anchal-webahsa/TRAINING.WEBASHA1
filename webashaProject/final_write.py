...
<style>
    ...
    .view-all { color: #3b82f6; font-size: 18px; cursor: pointer; }
    .status-container { display: flex; align-items: center; gap: 30px; }
    .chart-box { width: 150px; height: 150px; }
    .status-legend { flex: 1; }
    .legend-item { display: flex; align-items: center; gap: 10px; margin-bottom: 8px; font-size: 13px; color: #4b5563; }
    ...
    .withdrawal-panel { max-width: 600px; }
    .withdrawal-content { display: flex; justify-content: space-between; align-items: flex-end; }
    .user-info .name { font-weight: 600; color: #1f2937; margin-bottom: 4px; }
    .user-info .email { color: #6b7280; font-size: 13px; }
    .amount-box { text-align: right; }
    .amount { font-size: 18px; font-weight: 700; color: #1f2937; }
    .amount-label { font-size: 12px; color: #6b7280; }
    .panel h4 { margin-top: 0; margin-bottom: 24px; font-size: 16px; color: #0f172a; }
    .cards { margin-top: 10px; }
    .card { padding: 20px 24px !important; }
    .card .num { margin-bottom: 2px; }
</style>
{% endblock %}
"""
